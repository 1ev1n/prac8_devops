@echo off
REM Скрипт для развертывания приложения в Kubernetes (Windows)
...
kubectl apply -f k8s\todo-api-deployment.yaml -n todo-app
